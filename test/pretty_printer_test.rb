...
describe 'Printer tests' do
  ...
  it 'must work with string addition' do
    ...
    _(Oppen.print(tokens: list, width: 40))
      .must_equal 'XXXXXXXXXX + YYYYYYYYYY + ZZZZZZZZZZ'
    _(Oppen.print(tokens: list, width: 25))
  ...
  it 'must work with different delimiter' do
    ...
    _(Oppen.print(tokens: list, width: 25, new_line: '\n'))
      .must_equal 'XXXXXXXXXX + YYYYYYYYYY +\n  ZZZZZZZZZZ'
    _(Oppen.print(tokens: list, width: 20, new_line: '\n'))
  ...
  it 'must work with a string larger than line width' do
    ...
    _(Oppen.print(tokens: list, width: 9))
      .must_equal <<~LANG.chomp
        XXXXXXXXXX
          +
          YYYYYYYYYY
  ...
  it 'must work with cases' do
    ...
    _(Oppen.print(tokens: list, width: 75))
      .must_equal <<~LANG.chomp
        cases 1 : XXXXX
              2 : YYYYY
              3 : ZZZZZ
  ...
  it 'must work with different break types' do
    ...
    _(Oppen.print(tokens: list, width: 75))
      ...
      LANG
    _(Oppen.print(tokens: list, width: 24))
      .must_equal <<~LANG.chomp
        begin
          x := f(x); y := f(y);
          z := f(z); w := f(w);
